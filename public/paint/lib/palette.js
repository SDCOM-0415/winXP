        ...
        function (require, module, exports) {
          (function (global) {
            ...
            options = function (o) {
              ...
              if (o.file_name == null) {
                o.file_name =
                  (ref2 = (ref3 = o.fileName) != null ? ref3 : o.fname) != null
                    ? ref2
                    : (ref4 = o.file) != null
                    ? ref4.name
                    : void 0;
            ...
            Palette.load = function (o, callback) {
              ...
              if (!o) {
                throw new Error(
                  "Parameters required: Palette.load(options, function callback(err, palette){})"
                );
              }
              if (!callback) {
                throw new Error(
                  "Callback required: Palette.load(options, function callback(err, palette){})"
                );
              }
              o = options(o);
              if (o.data) {
                ...
                return callback(
                  new Error(
                    "Could not load. The File API may not be supported."
                  )
                );
              }
            };
            ...
            Palette.gimme = function (o, callback) {
              ...
              return Palette.load(o, function (err, palette) {
                return callback(
                  null,
                  palette != null ? palette : new RandomPalette()
                );
              });
            };
 ...
 */
          ...
          module.exports = BinaryReader = (function () {
            ...
            BinaryReader.prototype.readUnicodeString = function () {
              ...
              for (
                ...
                str += String.fromCharCode(
                  this._buffer.substr(this._pos, 1) |
                    (this._buffer.substr(this._pos + 1, 1) << 8)
                );
                this._pos += 2;
              }
              return str;
            ...
            BinaryReader.prototype._decodeFloat = function (
              precisionBits,
              exponentBits
            ) {
            ...
            function Color(arg) {
              ...
              if (this.r != null && this.g != null && this.b != null) {
                ...
                if (this.v != null) {
                  ...
                  this.s =
                    (this.s * this.v) /
                    (this.l < 50 ? this.l * 2 : 200 - this.l * 2);
                  if (isNaN(this.s)) {
                    this.s = 0;
                  }
                } else if (this.l != null) {
                  ...
                  throw new Error(
                    "Hue, saturation, and...? (either lightness or value)"
                  );
                }
                ...
                if (this.x != null && this.y != null && this.z != null) {
                  ...
                  throw new Error(
                    "Color constructor must be called with {r,g,b} or {h,s,v} or {h,s,l} or {c,m,y,k} or {x,y,z} or {l,a,b}"
                  );
                }
              }
            }
          ...
          module.exports = Palette = (function (superClass) {
            ...
            Palette.prototype.guess_dimensions = function () {
              ...
              for (j = 0, len1 = candidate_dimensions.length; j < len1; j++) {
                ...
                if (
                  Math.abs(cd[0] - cd[1]) < Math.abs(squarest[0] - squarest[1])
                ) {
        ...
        function (require, module, exports) {
          ...
          module.exports = function (arg) {
            ...
            while ((i += 1) < lines.length) {
              ...
              if (!r_g_b_name) {
                throw new Error(
                  "Line " + i + " doesn't match pattern r_g_b_name"
                );
              }
              palette.add({
                r: r_g_b_name[1],
      ...
      7: [
        function (require, module, exports) {
          ...
          module.exports = function (arg) {
            ...
            data.replace(
              /\#([0-9A-F]{2})?([0-9A-F]{3})([0-9A-F]{3})?(?![0-9A-F])/gim,
              function (m, $0, $1, $2) {
                var alpha, xRGB;
                alpha = hex($0);
                if ($2) {
            ...
            data.replace(
              /rgb\(\s*([0-9]{1,3}),\s*([0-9]{1,3}),\s*([0-9]{1,3})\s*\)/gim,
              function (m) {
            ...
            data.replace(
              /rgba\(\s*([0-9]{1,3}),\s*([0-9]{1,3}),\s*([0-9]{1,3}),\s*([0-9]{1,3}|0\.[0-9]+)\s*\)/gim,
              function (m) {
                return palette_rgb.add({
                  r: Number(m[1]),
                  g: Number(m[2]),
            ...
            data.replace(
              /hsl\(\s*([0-9]{1,3}),\s*([0-9]{1,3}),\s*([0-9]{1,3})\s*\)/gim,
              function (m) {
                return palette_rgb.add({
                  h: Number(m[1]),
                  s: Number(m[2]),
        ...
        function (require, module, exports) {
          ...
          module.exports = function (arg) {
            ...
            if (palVersion !== 0x0300) {
              throw new Error(
                "Unsupported PAL file version: 0x" + palVersion.toString(16)
              );
            }
            palette = new Palette();
            i = 0;

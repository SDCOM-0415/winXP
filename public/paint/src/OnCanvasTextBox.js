class OnCanvasTextBox extends OnCanvasObject {
  constructor(x, y, width, height, starting_text) {
    ...
    const update = () => {
      ...
      font.background = tool_transparent_mode
        ? "transparent"
        : colors.background;
      ...
      var data_url = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(
        svg_source
      )}`;
    ...
    const $fb = (OnCanvasTextBox.$fontbox =
      OnCanvasTextBox.$fontbox || new $FontBox());
